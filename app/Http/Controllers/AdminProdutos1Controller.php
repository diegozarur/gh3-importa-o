<?php namespace App\Http\Controllers;
	...
	class AdminProdutos1Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"Valor","name"=>"valor","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
	        ...
	        */
//	        $this->alert        = array();
//          $this->alert[] = ['message'=>'Produto Adicionado Com Sucesso !','type'=>'info'];
